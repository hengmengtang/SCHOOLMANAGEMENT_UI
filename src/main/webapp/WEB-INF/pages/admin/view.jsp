                ...
                id="bs-example-navbar-collapse-1">
                  <form id="defaultForm" method="post" action="javascript:;">
                    <ul class="nav navbar-nav navbar-right">
                      ...
                      In</a>
                      <a href="#" class="btn btn-info" style="top:-17px;padding: 8px;left:80px" id="check">Check</a>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body form-horizontal">
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" name="age" placeholder="Input age" ng-model="age" ng-pattern="/^[0-9]{1,3}$/" required>
				    </div>
 			 	</div>
		      </div>

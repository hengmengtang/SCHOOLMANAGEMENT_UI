      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         <a href="#">
          ...
          <ul class="treeview-menu" style="display: none;">
            <li><a href="#" ><i class="fa fa-circle-o"></i> Student Register</a></li>
        ...
        <li class="treeview">
         <a href="#">
          ...
          <ul class="treeview-menu" style="display: none;">
            <li><a href="#" ><i class="fa fa-circle-o"></i> Generation</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Instructor Enroll</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

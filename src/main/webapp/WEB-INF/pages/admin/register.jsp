      ...
      <fieldset>
          ...
          <div class="row" style="margin: 3px;">
            ...
            <div class="col-md-10 pull-left">
              ...
              <span style="font-size: 16px;">Add Student's Information</span>
            </div>

            <div class="form-group col-md-2 pull-right">
              <label for="exampleInputFile">
                <img src="${pageContext.request.contextPath }/resources/images/user.ico" alt="" class="img-circle img-responsive " style="width: 180px; height: 180px; border:1px solid black;"> 
              </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                  <label for="exampleInputFLName">First Latin Name <span class="star"> * </span></label>
                  <span class="glyphicons glyphicons-user"></span>
                  <input type="text" class="form-control " id="exampleInputFLName" placeholder="Enter Your First Latin Name" name="latin_fname">
              </div>
              <div class="form-group col-md-6">
                  <label for="exampleInputLLName">Last Latin Name <span class="star"> * </span></label>
                  <input type="text" class="form-control" id="exampleInputLLName" placeholder="Enter Your Last Latin Name" name="latin_lname">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="exampleInputBOF">Birth Date <span class="star"> * </span></label>
                <input type="text" class="form-control" id="exampleInputBOF" placeholder="Birth Date" name="dob">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                  ...
                  <select class="form-control" id="exampleInputPosition" name="position">
                     <option>Admin</option>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="exampleInputMotherName" placeholder="Father's Name" name="mother_name">
              </div>
              <div class="form-group col-md-6">
                  <label for="exampleInputMotherLName">Mother's Latin Name</label>
                  <input type="text" class="form-control" id="exampleInputMotherLName" placeholder="Father's Latin Name" name="mother_latin_name">
              </div>
            </div>

            <div class="row">
              <div class="form-group col-md-6">
                  <label for="exampleInputFName">Father's Phone</label>
                  <input type="text" class="form-control" id="exampleInputFName" placeholder="Father's Phone " name="father_phone">
              </div>
              <div class="form-group col-md-6">
                  <label for="exampleInputLName">Mother's Phone</label>
                  <input type="text" class="form-control" id="exampleInputLName" placeholder="Mother's Phone" name="mother_phone">
              </div>
            </div>
          
          <div class="row pull-right" style="margin: 7px;">
            <!-- Contextual button for informational alert messages -->
            <button type="submit" class="btn" style="font-width: 20px;color: white;background-color: green;"> Add</button>
          </div>  
      </fieldset>
      </div>
    </form>

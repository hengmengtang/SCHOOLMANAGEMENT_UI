						...
						<div class="panel-body">
							<div class="row">
								<div class="form-group col-md-3">
									<label for="exampleInputStuID">Student ID: <span
										...
										class="form-control " id="exampleInputStuID"
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="exampleInputLName">Last Name <span
										...
										class="form-control" id="exampleInputLName"
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="exampleInputFLName">First Latin Name <span
										class="star"> * </span></label> <span
										class="glyphicons glyphicons-user"></span> <input type="text"
										class="form-control " id="exampleInputFLName"
										placeholder="Enter Your First Latin Name" name="latin_fname">
								</div>
								<div class="form-group col-md-6">
									<label for="exampleInputLLName">Last Latin Name <span
										class="star"> * </span></label> <input type="text"
										class="form-control" id="exampleInputLLName"
										placeholder="Enter Your Last Latin Name" name="latin_lname">
								</div>
							</div>
							<!--Radio-->
							<div class="row">
								<div class="form-group col-md-3">
									<label>Gender <span class="star"> * </span></label> <br> <label
										...
										class="flat-red" name="gender" id="inlineRadio1"
										value="option1"> Male
									</label> <label class="radio-inline"> <input type="radio"
										class="flat-red" name="gender" id="inlineRadio2"
							...
							<div class="row">
								<div class="form-group col-md-4">
									<label for="exampleInputEmail2">Email <span
										...
										placeholder="your_email@gmail.com" name="email">
								</div>
								<div class="form-group col-md-4">
								...
								<div class="form-group col-md-4">
									<label for="exampleInputPosition">Position <span
										class="star"> * </span></label> <input type="input"
										class="form-control" id="exampleInputPosition" name="position"
										value="student" readonly="readonly">
							...
							<div class="row">
								<div class="form-group col-md-4">
									...
									</span></label> <select class="form-control" id="ITYear" name="it_year">
								...
								<div class="form-group col-md-4">
									<label for="exampleInputUniversity">University</label> <select
										class="form-control" id="exampleInputPosition"
										name="university">
										<option>Select - Option</option>
										<option>RUPP</option>
										<option>RULE</option>
						...
						<div class="col-md-4" style="font-size: 22px;">
							...
							<div class="row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control"
										id="exampleInputFatherName" placeholder="Father's Name"
										name="father_name">
								</div>
								<div class="form-group col-md-6">
							...
							<div class="row pull-right" style="margin: 7px;">
								...
								<button type="submit" class="btn"
									style="font-width: 20px; color: white; background-color: #1565C0;">
									Update</button>
							</div>
						</div>
					</div>

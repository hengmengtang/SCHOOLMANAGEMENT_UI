...
<script src="${pageContext.request.contextPath }/resources/plugins/input-mask/inputmask.js"></script>
<script src="${pageContext.request.contextPath }/resources/plugins/input-mask/jquery.inputmask.phone.extensions.js"></script>
